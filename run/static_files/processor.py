...
from PhysicsTools.NanoHc.producers.ZtoEE import EventProducerEE
from PhysicsTools.NanoHc.producers.ZtoMM import EventProducerMM
...
p = PostProcessor(
    ...
    modules=[
            ...
            EventProducerEE(year, dataset_type, sample),
            EventProducerMM(year, dataset_type, sample),
